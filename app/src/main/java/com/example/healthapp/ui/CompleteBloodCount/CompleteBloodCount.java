...
public class CompleteBloodCount extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View root = inflater.inflate(R.layout.blood_pressure_fragment, container, false);
    ...
    private void setUpViewPager(ViewPager viewPager) {
        ...
        sectionPagerAdapter.addFragment(new CompleteBloodCountForm(), "Form");
