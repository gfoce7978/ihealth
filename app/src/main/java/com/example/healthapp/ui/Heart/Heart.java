...
import com.example.healthapp.ui.BloodPressure.BloodPressure;
import com.example.healthapp.ui.BloodPressure.BloodPressureViewModel;
...
public class Heart extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View root = inflater.inflate(R.layout.heart_fragment, container, false);
    ...
    private void setUpViewPager(ViewPager viewPager) {
        ...
        sectionPagerAdapter.addFragment(new Heart_Form(), "Form");
